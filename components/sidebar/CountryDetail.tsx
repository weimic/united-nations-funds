                ...
                <div className="space-y-2">
                  {allCrises.map(({ crisis, entry }) => (
                    <button
                      ...
                      className="cursor-pointer w-full rounded border border-red-500/15 bg-red-500/5 p-2.5 text-left hover:border-red-500/35 hover:bg-red-500/10 transition-all"
                    >
